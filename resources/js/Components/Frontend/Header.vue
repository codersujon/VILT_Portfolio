    ...
    <nav class="bg-light-secondary border-gray-200 dark:bg-dark-primary">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://codersujon.com/" class="flex items-center space-x-3 rtl:space-x-reverse" target="_blank">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CoderS</span>
            </a>
            ...
            <div class="w-full md:block md:w-auto" id="navbar-default" :class={hidden:showMobileMenu}>
                <ul
                    class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-light-tail-500 dark:border-dark-navy-100 rounded-lg bg-light-secondary md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-dark-secondary md:dark:bg-gray-900">
                    <li>
                        <a href="#"
